...
export const eligibilityCheckSchema = Joi.object({
  ...
  patientMiddleName: Joi.string().allow("", null),
  ...
  effectiveDate: Joi.string().allow("", null),
  terminationDate: Joi.string().allow("", null),
  rxBin: Joi.string().allow("", null),
  rxPcn: Joi.string().allow("", null),
  rxGroup: Joi.string().allow("", null),
  copayPcp: Joi.string().allow("", null),
  copaySpecialist: Joi.string().allow("", null),
  subscriberName: Joi.string().allow("", null),
  subscriberDob: Joi.string().allow("", null),
  subscriberRelationship: Joi.string().allow("", null),
  secondaryPayer: Joi.string().allow("", null),
  secondaryMemberId: Joi.string().allow("", null),
  secondaryGroupNumber: Joi.string().allow("", null),
  secondaryPlanName: Joi.string().allow("", null),
...
export const bulkEligibilityRowSchema = Joi.object({
  ...
  plan_type: Joi.string().allow("", null),
  effective_date: Joi.string().allow("", null),
  termination_date: Joi.string().allow("", null),
  rx_bin: Joi.string().allow("", null),
  rx_pcn: Joi.string().allow("", null),
  rx_group: Joi.string().allow("", null),
  copay_pcp: Joi.string().allow("", null),
  copay_specialist: Joi.string().allow("", null),
  subscriber_name: Joi.string().allow("", null),
  subscriber_dob: Joi.string().allow("", null),
  subscriber_relationship: Joi.string().allow("", null),
  secondary_payer: Joi.string().allow("", null),
  secondary_member_id: Joi.string().allow("", null),
  secondary_group_number: Joi.string().allow("", null),
  secondary_plan_name: Joi.string().allow("", null),
  provider_npi: Joi.string().allow("", null),
  cpt_code: Joi.string().allow("", null),
  facility_name: Joi.string().allow("", null),
  notes: Joi.string().allow("", null),
